...
const sections = [
  {
    ...
    body: [
      ...
      `Володілець персональних даних та продавець: ${seller.legalName}, ІПН/РНОКПП ${seller.taxId}.`,
  ...
  },
  {
    ...
    body: [
      "Дані, які ви надаєте самостійно: ім’я, номер телефону, email та інша інформація, яку ви добровільно передаєте через форми на сайті, під час оплати або комунікації з нами.",
      "Технічні дані: адреса сторінки, джерело переходу, тип пристрою, браузер, IP-адреса, cookies та інші стандартні технічні дані, якщо вони передаються браузером або сервісами аналітики.",
      "Ми не просимо та не зберігаємо повні реквізити банківських карток на цьому сайті. Платіжні дані обробляються платіжним провайдером відповідно до його правил та стандартів безпеки.",
    ],
  },
  {
    ...
    body: [
      ...
      "Для проведення оплати, ідентифікації замовлення, організації доступу до придбаного цифрового продукту та підтримки користувачів.",
  ...
  },
  {
    ...
    body: [
      "Ми обробляємо персональні дані, коли це необхідно для виконання вашого запиту або договору, на підставі вашої згоди, а також у випадках, коли обробка необхідна для виконання законних обов’язків або захисту законних інтересів.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "Дані можуть передаватися сервісам, необхідним для роботи сайту та виконання замовлення: хостингу, платіжним провайдерам, зокрема WayForPay після підключення, сервісам аналітики, зв’язку або технічним підрядникам — лише в обсязі, необхідному для відповідної послуги.",
      "Інформація також може бути розкрита у випадках, прямо передбачених законодавством.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "Доступ до адміністративної частини сайту обмежений, а передача даних між браузером і сайтом здійснюється через HTTPS-з’єднання.",
          ...
          <div className="container-x grid gap-10 lg:grid-cols-[0.32fr_0.68fr] lg:gap-20">
            <aside className="lg:sticky lg:top-28 lg:self-start">
              <div className="rounded-[22px] border border-linen bg-sand/55 p-6">
                ...
                <p className="mt-3 text-[13px] leading-relaxed text-ink-soft">
                  Ми використовуємо дані лише для роботи сайту, обробки заявок, оплати, надання доступу до продукту та покращення сервісу.
                </p>
            ...
            <article className="divide-y divide-linen border-y border-linen">
              ...
              <section className="py-8 md:py-10">
                <h2 className="font-display text-[28px] leading-tight text-ink md:text-[34px]">
                  12. Контакти та реквізити продавця
                </h2>
                <div className="mt-5 space-y-2 text-[14px] leading-[1.8] text-ink-soft md:text-[15px]">
                  <p>{seller.legalName}</p>
                  <p>ІПН/РНОКПП: {seller.taxId}</p>
                  <p>Юридична адреса: {seller.legalAddress}</p>
                  <p>Фактична адреса: {seller.actualAddress}</p>
                  <p>Телефон: <a href={seller.phoneHref} className="underline underline-offset-4">{seller.phone}</a></p>
                  <p>Email: <a href={seller.emailHref} className="underline underline-offset-4">{seller.email}</a></p>
                </div>
              </section>
            </article>
          </div>
